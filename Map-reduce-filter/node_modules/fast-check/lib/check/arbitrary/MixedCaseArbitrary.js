...
class MixedCaseArbitrary extends Arbitrary_1.Arbitrary {
    ...
    wrapper(rawCase, chars, togglePositions, flags) {
        ...
        return new Shrinkable_1.Shrinkable(newChars.join(''), () => this.shrinkImpl(rawCase, chars, togglePositions, flags));
    }
    shrinkImpl(rawCase, chars, togglePositions, flags) {
        return rawCase
            ...
            .shrink()
            .map((nFlags) => {
            return this.wrapper(new Shrinkable_1.Shrinkable(rawCase.value), chars, togglePositions, nFlags.value_);
        }));
    }
    generate(mrng) {
